...
const componentSchema = new mongoose.Schema({
  ...
  uom: { type: String},        // Unit of Measure (e.g., KGS, NOS)
});
...
const stageSchema = new mongoose.Schema({
  ...
  unitMaterialPerProduct:{ type: Number, required: true },                       // List of components for the stage
});
...
const bomSchema = new mongoose.Schema({
  ...
  uom: { type: String},            // Unit of measure for output (e.g., PCS, KGS)
